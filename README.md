...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/Pulverizeflafight/zapret-telegram">Pulverizeflafight/zapret-telegram</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />

**Discord · YouTube · Telegram** — работает, когда «Connecting…» и тормоза  

Скачать актуальную сборку в [**Releases → DiscordFix**](https://github.com/Pulverizeflafight/zapret-telegram/releases/tag/DiscordFix)
...
[Инструкция по установке и частые вопросы](https://pulverizeflafight.github.io/zapret-telegram/)
...
> Если вы наткнулись на что-то вне репозитория `Pulverizeflafight/zapret-telegram`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы релиза DiscordFix](https://github.com/Pulverizeflafight/zapret-telegram/releases/tag/DiscordFix)
...
Если этого не произошло, то см. [#522](https://github.com/Pulverizeflafight/zapret-telegram/issues/522)
...
- См. [#765](https://github.com/Pulverizeflafight/zapret-telegram/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/Pulverizeflafight/zapret-telegram/releases/tag/DiscordFix) (`zapret-discord-youtube-DiscordFix.rar` / `zapret-discord-youtube-DiscordFix.zip`)
...
- См. также [#251](https://github.com/Pulverizeflafight/zapret-telegram/discussions/251)
...
- См. также [#252](https://github.com/Pulverizeflafight/zapret-telegram/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/Pulverizeflafight/zapret-telegram/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/Pulverizeflafight/zapret-telegram/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/Pulverizeflafight/zapret-telegram/blob/main/LICENSE.txt)
